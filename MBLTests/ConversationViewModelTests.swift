...
class ConversationViewModelTests: XCTestCase {
    ...
    override func setUp() {
        conversationViewModel = ConversationViewModel(userInfo: UserData(name: "Adrien", lastName: "PEREA", userID: "123", city: "Paris", picture: "pic1", refPic: "refPic1"), conversationID: "12345")
    }
